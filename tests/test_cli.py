...
def test_init_succeeds_with_valid_env(
    ...
    # 9 app roles + `patient_simulator`, which is test-harness only
    # (`scripts/intake-replay --persona`) and reached by no DAG stage.
    assert "loaded 10 model role bindings" in out
